        ...
        <div class="col mt-3 md-4 mb-2 bg-secondary ml-3 ">
            <div class="card mt-4 mb-3 ml-3 mr-4">
                <div class="card-header text-dark mt-0 ">
                    <h5 class="font-weight-bold">Ubah Data Toko</h5>
                ...
                <div class="card-body mb-4  ">
                    ...
                    <form action="" method="post">
                        ...
                        <input type="hidden" value="<?php// $tb_toko['id_toko']; ?>">
                        <div class="row">
                            <div class="col-md-8 mt-0">
                                <label for="kd_toko" class="font-weight-bold">kode toko*</label>

                                <input type="text" class="form-control form-control <?= form_error('kd_toko') ? 'is-invalid' : '' ?>" placeholder="" id="kd_toko" name="kd_toko" value="<?= $tb_toko['kd_toko']; ?>" autocomplete="off">
                            ...
                            <div class="col-md-8 mt-3">
                                ...
                                <input type="text" class="form-control form-control <?= form_error('nm_toko') ? 'is-invalid' : '' ?>" placeholder="nm_toko lengkap" id="nm_toko" name="nm_toko" value="<?= $tb_toko['nama_toko']; ?> " autocomplete="off">
                            ...
                            <div class="col-md-8 mt-3">
                                ...
                                <input type="text" class="form-control form-control <?= form_error('zona') ? 'is-invalid' : '' ?>" placeholder="zona lengkap" id="zona" name="zona" value="<?= $tb_toko['zona'] ?> " autocomplete="off">
                            ...
                            <div class="col-md-8 mt-3">
                                ...
                                <input type="text" class="form-control form-control <?= form_error('kcm') ? 'is-invalid' : '' ?>" placeholder="kcm lengkap" id="kcm" name="kcm" value="<?= $tb_toko['kecamatan'] ?> " autocomplete="off">
                            ...
                            <div class="col-md-8 mt-3">
                                ...
                                <input type="text" class="form-control form-control <?= form_error('kota') ? 'is-invalid' : '' ?>" placeholder="" id="kota" name="kota" value="<?= $tb_toko['kota'] ?>" autocomplete="off">
                                <div class="invalid-feedback">
                                    <?= form_error('kota') ?>
                                </div>
                            ...
                            <div class="col-md-8 mt-3">
                                ...
                                <button type="submit" name="tambah" class="btn btn-dark btn-flat "><i class="fa fa-paper-plane"></i>ubah</button>
